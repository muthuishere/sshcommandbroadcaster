 ...
 */
package com.sshutils.views.console;
...
import com.sshutils.views.MultiMainDialogue;
...
public class ConsoleWindow extends javax.swing.JFrame {
    ...
    public synchronized void appendText(String txt) {
        ...
        try {
            ...
            log.error("Bad Location exception",ex);
        }
    ...
    public void showPrompt(boolean flgNewLine) {
        ...
        txtAreaConsole.setCaretPosition(txtAreaConsole.getDocument().getLength());
        promptPosition=txtAreaConsole.getDocument().getLength();
        txtAreaConsole.setEditable(true);
    }
    ...
    private void initComponents() {
        ...
        txtAreaConsole.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                txtAreaConsoleCaretUpdate(evt);
            }
        });
    ...
    private void txtAreaConsoleCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtAreaConsoleCaretUpdate
        // TODO add your handling code here:
        
 
        if(evt.getDot() < promptPosition && promptPosition <= txtAreaConsole.getDocument().getLength())                
                 txtAreaConsole.setCaretPosition(promptPosition);
            
        //promptPosition=txtAreaConsole.getDocument().getLength();
        
    }//GEN-LAST:event_txtAreaConsoleCaretUpdate
